  ...
  return (
    ...
    >
      ...
      {status === "active" && (
        ...
        >
          <Link to={`/apply/${id}`} className="btn btn-primary btn-lg bg-gradient-to-r from-violet-700 to-violet-500 hover:from-violet-600 hover:to-violet-400 text-white font-bold px-6 py-3 rounded-full shadow-lg">
            Apply Now
          </Link>
        </motion.div>
      )}
